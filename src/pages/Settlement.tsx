...
import { CheckCircle2, Share2, ArrowRight, Trophy } from 'lucide-react';
    ...
    <div className="min-h-full bg-slate-50 flex flex-col px-6 py-10">
      <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
        ...
        <div className="w-full grid grid-cols-2 gap-4">
          <Card className="border-none shadow-sm bg-white overflow-hidden">
            <CardContent className="p-4 text-center">
              <p className="text-[10px] text-slate-400 font-bold uppercase mb-1">本次运动</p>
              <p className="text-2xl font-black text-emerald-600">3.56<span className="text-xs ml-0.5">km</span></p>
            </CardContent>
          </Card>
          <Card className="border-none shadow-sm bg-white overflow-hidden">
            <CardContent className="p-4 text-center">
              <p className="text-[10px] text-slate-400 font-bold uppercase mb-1">消耗热量</p>
              <p className="text-2xl font-black text-orange-500">245<span className="text-xs ml-0.5">kcal</span></p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="w-full bg-white border border-slate-100 rounded-[2.5rem] p-8 flex items-center justify-between shadow-sm relative overflow-hidden">
          ...
          <div className="text-left relative z-10">
            <p className="text-[10px] text-orange-600 font-black mb-1 uppercase tracking-widest">能量换算</p>
            ...
            <p className="text-slate-400 font-bold text-xs mt-1">食堂同款 · 爱心荷包蛋 🍳</p>
          </div>
          <motion.div 
        ...
        {/* Path Preview */}
        <div className="w-full h-56 rounded-[2.5rem] overflow-hidden relative border border-slate-100 shadow-md group">
          <img src="https://modao.cc/agent-py/media/generated_images/2026-04-30/4fd31ef78d704f5791f56b01bf550bd0.jpg#desc=High%20Quality%20Perspective%20View%20of%20Campus%20Sports%20Field%20with%20Red%20GPS%20Running%20Track" alt="Track Path" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
          ...
          <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-white text-xs font-black uppercase tracking-widest">解锁勋章</p>
                <p className="text-yellow-400 text-sm font-black">校园清晨跑者</p>
              </div>
            </div>
      ...
      <div className="mt-12 space-y-4">
        <div className="flex gap-4">
          ...
          >
            <Share2 size={20} className="text-emerald-500" /> 分享成就
          </Button>
        </div>
        <Button 
